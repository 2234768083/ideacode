...
public class MybatisCodeGenerator {
    ...
    private static final String schemaName = "video-sys";   // 数据库名称，必填
    ...
    static void createVue(String entityName, String tableName) throws SQLException {
        ...
        for (TableColumn tableColumn : tableColumns) {
            ...
            // 生成表格
            tableColumnBuilder.append(space6 + "<el-table-column prop=\"" + tableColumn.getColumnName() + "\" label=\"" + tableColumn.getColumnComment() + "\"> </el-table-column>\n");
            formItemBuilder.append(space8 + "<el-form-item label=\"" + tableColumn.getColumnComment() + "\" label-width=\"100px\">\n")
                    .append(space10 + "<el-input v-model=\"entity." + tableColumn.getColumnName() + "\" autocomplete=\"off\" style=\"width: 80%\"></el-input>\n")
                    .append(space8 + "</el-form-item>\n");
        }
